...
/** 
 * La classe <code>PaintAccueil</code> est une classe qui hérite de <code>JPanel</code> et qui fait un panneau personnalisé
 * Cette classe dessine l'écran d'accueil, donc met le titre complet avec un background
 * 
 * @version 1.0
...
public class PaintAccueil extends JPanel{
	...
	/**
     * Constructeur de la classe <code>PaintAccueil</code>
     * Charge l'image de fond dans le dossier Images
     */
	public PaintAccueil(){
		super();
		this.background = Toolkit.getDefaultToolkit().getImage("Images/background.jpg");
	}
	...
	protected void paintComponent(Graphics pinceau){ 
		...
		secondpinceau.drawString("Denis crush", 360 + 3, 100 + 3); // Ombre du titre en noir

		secondpinceau.setColor(new Color(139,0,0));
		secondpinceau.drawString("Denis crush", 360, 100); // Titre en rouge 

		secondpinceau.setColor(Color.BLACK);
		secondpinceau.setFont(new Font("Arial", Font.PLAIN, 30));
		secondpinceau.drawString("Edition charisme divin", 370, 150); // Suite du titre un peu plus bas en noir
	}
}