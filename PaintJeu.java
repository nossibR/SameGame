...
public class PaintJeu extends JPanel {
    ...
    public PaintJeu(int valeur) {
        ...
        switch (valeur) {
        case 1:
            image = Toolkit.getDefaultToolkit().getImage("Images/lune.jpg");
            break;
        case 2:
            image = Toolkit.getDefaultToolkit().getImage("Images/soleil.jpg");
            break;
        case 3:
            image = Toolkit.getDefaultToolkit().getImage("Images/saturne.jpg");
            break;
        default:
            image = null;
        }
